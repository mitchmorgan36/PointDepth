...
The source point group prompt excludes PointDepth's generated output groups so reruns do not accidentally process only a previous positive or negative subset.
